...
import { categoryProductsAction, getSelectedProduct, selectCategories, selectProduct } from "../../store/loader/loader-slice"
            ...
            <main className="container-page-product">
                {
                    !!Object.keys(product).length &&
                        <div className="wrapper-page-product">
                            ...
                            <button 
                                className="page-product-btn-add-review-user primary"
                                type="button"
